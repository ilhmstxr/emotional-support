...
<body>
    @section('content')
                ...
                <div class="row gx-5 px-5 pb-4">
                    ...
                    @foreach ($consultant_info as $ci)
                        <div class="col">
                            ...
                            <button type="button" class="btn btn-outline text-center my-2"
                                href="#"style="color : #2D9CDB; border-color : #2D9CDB; border-radius: 7px;">Lihat
                                Selengkapnya</button>
                        </div>
                    @endforeach
        ...
        <div class="text-center mb-5">
            <button type="button" href="#" class="btn hpoppins"
                style="background-color: #2D9CDB; color:#FFFFFF;">Lihat Semua</button>
        </div>
