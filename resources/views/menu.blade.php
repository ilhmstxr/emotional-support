...
<body>
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <img src="{{ '/img/karusel.png' }}" class=" w-50" style="text-align:center" alt="home">
                    <h3 class="hpoppins" style="color: #2D9CDB;">
                        Tempat yang aman untuk berbagi pengalaman, mendapatkan dukungan, dan memperoleh pengetahuan
    ...
    <div class="homegutter">
        ...
        <div class="container overflow-hidden text-center mx-10 py-4">
            <div class="row gx-5 px-5">
                <div class="col text-center">
                    ...
                    <div class="">
                        <p>Saatnya pilih cara curhat paling nyaman untukmu. Bisa tatap muka maupun online, semua pasti
                            bisa!</p>
                    </div>
                </div>
                <div class="col">
                ...
                <div class="col">
                    ...
                    <div class="p-3" style="font-weight: bold;">Tuangkan Isi Hati Pada Yang Ahli Dengan Harga
                        Terjangkau</div>
                    <div class="">
        ...
        <div class="container overflow-hidden text-center">
            <div class="row gx-5 px-5 pb-4">
                ...
                @foreach ($consultant_info as $ci)
                <div class="col">
                    <img src="{{ '/img/profile.png' }}" width="130px">
                    <div class="p-3" style="font-weight: bold;">{{ $ci->user->name }} {{ $ci->degree }}</div>
                    <div class="container text-start">
                        <div class="row">
                            ...
                            <div class="col">
                                <p class="pSora" style="text-align:start">{{ $ci->sessions }} Sesi </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-1">
                            ...
                            <div class="col">
                                <p class="pSora" style="text-align:start">{{ number_format(($ci->helped / $ci->sessions) * 100, 0,'.','')  }}%
                                    Terbantu</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <p class="pSora" style="text-align:start">{{ $ci->expert_in }}</p>
                            </div>
                        </div>

                    </div>
                    <button type="button" class="btn btn-outline text-center my-2" style="color : #2D9CDB; border-color : #2D9CDB; border-radius: 7px;">Lihat
                        Selengkapnya</button>
    ...
    <div class="text-center mb-5">
        <button onclick="redirectToPsikolog()" type="button" href="#" class="btn hpoppins" style="background-color: #2D9CDB; color:#FFFFFF;">Lihat Semua</button>
    </div>
    ...
    <script>
        function redirectToPsikolog() {
            window.location.href = '/psikolog';
        }
    </script>
</body>
