            ...
            <div class="col-md-4 border-profile text-center">
                <figure>
                    ...
                    <form action="{{ route('profilepsikolog', $c->user->id) }}">
                        ...
                        <button type="submit" class="btn btn-outline text-start pSora my-2" style="color : #2D9CDB; border-color : #2D9CDB; border-radius: 7px; float:inline-start">
                ...
                <div class="button-group mx-auto">
                    ...
                    <form action="">
                        <button type="button" class="text-start hpoppins p-3 mb-2 mr-4" style="background-color:#EAEAEA; color : #FFFFFF; border-color : #EAEAEA; border-radius: 7px; float:inline-start" disabled>
                            offline</button>
                    </form>
                    @else
                    <form action="">
                        <button type="button" class="text-start hpoppins p-3 mb-2 mr-4" style="background-color:#FFAA4A; color : #FFFFFF; border-color : #FFAA4A; border-radius: 7px; float:inline-start" disabled>
                            Sibuk</button>
                    </form>
                    @endif
                    @else
                    ...
                    <button type="button" class="text-start hpoppins p-3 mb-2 mr-4" style="background-color:#FFAA4A; color : #FFFFFF; border-color : #FFAA4A; border-radius: 7px; float:inline-start" disabled>
                        Sibuk</button>
                    @else
                    <button type="button" class="text-start hpoppins p-3 mb-2 mr-4" style="background-color:#FF4500; color : #FFFFFF; border-color : #FF4500; border-radius: 7px; float:inline-start" disabled>
                        Offline</button>
                    @endif
