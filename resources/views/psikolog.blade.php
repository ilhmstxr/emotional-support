                    ...
                    <div class="col-md-4 border-profile text-center">
                        <figure>
                            ...
                            <form action="{{ route('profilepsikolog', $c->user->id) }}">
                                ...
                                <div>
                                    <figcaption class="pSora" style="text-align: left; color:#808080;">Harga Janji Temu :
                                        Rp {{ $c->price_meet }}</figcaption>
                                    <figcaption class="pSora" style="text-align: left; color:#808080;">Harga Online : Rp
                                        {{ $c->price_online }}</figcaption>
                                </div>
