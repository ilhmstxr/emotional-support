    ...
    <div class="messenger">
            ...
            <div class="m-header m-header-messaging">
                <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                        ...
                        <div class="pSora"
                            style="background-color: #2D9CDB; color:#FFFFFF; display:inline-flex; margin-left:5px; padding-top:16px; border-radius:7px;">
        ...
        <script>
            ...
            function refreshContent(rent) {
                ...
                var time = countdown(new Date({{ $year }}, $month, $day,
                    $endHour, $minute, $second));
